...
mtfs <- read_rds(here("code", "results", "mt_fail_summary_for_index.rds")) %>% 
  filter(gsp_name == params$selected_gsa) 
  #filter(gsp_name == "ALL") # debugging
...
tags$div(
  ...
  tags$div(
    ...
    tags$a(href = paste0(root, "alpaugh_tule", selected_decline), "Alpaugh (Tule)"),
    tags$a(href = paste0(root, "buena_vista_kern", selected_decline), "Buena Vista (Kern)"),
    tags$a(href = paste0(root, "central_kings", selected_decline), "Central Kings"),
    tags$a(href = paste0(root, "chowchilla", selected_decline), "Chowchilla"),
    tags$a(href = paste0(root, "delano_earlimart_tule", selected_decline), "Delano-Earlimart (Tule)"),
    tags$a(href = paste0(root, "east_kaweah", selected_decline), "East Kaweah"),
    tags$a(href = paste0(root, "east_tule", selected_decline), "East Tule"),
    tags$a(href = paste0(root, "eastern_san_joaquin", selected_decline), "Eastern San Joaquin"),
    tags$a(href = paste0(root, "farmers", selected_decline), "Farmers (DM)"),
    tags$a(href = paste0(root, "fresno_county", selected_decline), "Fresno County (DM)"),
    tags$a(href = paste0(root, "grassland", selected_decline), "Grassland (DM)"),
    tags$a(href = paste0(root, "gravelly_ford_madera", selected_decline), "Gravelly Ford (Madera)"),
    tags$a(href = paste0(root, "greater_kaweah", selected_decline), "Greater Kaweah"),
    tags$a(href = paste0(root, "henry_miller_kern", selected_decline), "Henry Miller (Kern)"),
    tags$a(href = paste0(root, "james_kings", selected_decline), "James (Kings)"),
    tags$a(href = paste0(root, "kern_groundwater_authority", selected_decline), "Kern Groundwater Authority"),
    tags$a(href = paste0(root, "kern_river", selected_decline), "Kern River"),
    tags$a(href = paste0(root, "kings_river_east", selected_decline), "Kings River East"),
    tags$a(href = paste0(root, "lower_tule_river", selected_decline), "Lower Tule River"),
    tags$a(href = paste0(root, "madera_joint", selected_decline), "Madera Joint"),
    tags$a(href = paste0(root, "mc_mullin", selected_decline), "Mc Mullin"),
    tags$a(href = paste0(root, "merced", selected_decline), "Merced"),
    tags$a(href = paste0(root, "mid_kaweah", selected_decline), "Mid Kaweah"),
    tags$a(href = paste0(root, "new_stone_madera", selected_decline), "New Stone (Madera)"),
    tags$a(href = paste0(root, "north_fork_kings", selected_decline), "North Fork Kings"),
    tags$a(href = paste0(root, "north_kings", selected_decline), "North Kings"),
    tags$a(href = paste0(root, "northern_central", selected_decline), "Northern Central (DM)"),
    tags$a(href = paste0(root, "pixley_tule", selected_decline), "Pixley (Tule)"),
    tags$a(href = paste0(root, "root_creek_madera", selected_decline), "Root Creek (Madera)"),
    tags$a(href = paste0(root, "sjrec", selected_decline), "SJREC (DM)"),
    tags$a(href = paste0(root, "south_kings", selected_decline), "South Kings"),
    tags$a(href = paste0(root, "tri_county_tule", selected_decline), "Tri-County (Tule)"),
    tags$a(href = paste0(root, "tulare_lake", selected_decline), "Tulare Lake"),
...
leaflet() %>% 
  ...
  addLayersControl(
    overlayGroups = og,
    baseGroups    = c("2040 min threshold", "2019 groundwater level"),
